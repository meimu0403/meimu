...
public class Practice {
	...
	public static void main(String[] args) {
		...
		System.out.println("国語の平均点は" + (test[0][0] + test[1][0] + test[2][0] + test[3][0])/test.length + "です。") ;
		System.out.println("数学の平均点は" + (test[0][1] + test[1][1] + test[2][1] + test[3][1])/test.length + "です。") ;
		System.out.println("英語の平均点は" + (test[0][2] + test[1][2] + test[2][2] + test[3][2])/test.length + "です。") ;
